...
def main():
    ...
    splits_window = gui.Listbox(values=['testAdd'],
                                size=(120, 16),
                                key='splits_window',
    ...
    splits_table = gui.Table(values=[[1, 4], [2, 5], [3, 6],],
                             headings=['a', 'b'],
                             auto_size_columns=False,
                             col_widths=(108, 12))


    layout = [[splits_table], [splits_window], [splits_input], [total_timer],
    ...
    window = gui.Window('PySplit6', layout, finalize=True, font=('CenturyGothic', 20))
